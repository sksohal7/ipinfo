...
def ipinfo():
       ...
       print (" ")
       slowprint("\033[1;36m =====================================")
       slowprint("\033[1;33m|        Coded By sksohel             |")
       slowprint("\033[1;36m =====================================")
       slowprint("\033[1;91m|       sohelsk07.blogspot.com        |")
       slowprint("\033[1;36m =====================================")
       print (" ")
...
def about():
       ...
       slowprint ("\033[1;33m" + "         [+] Autor         =>\033[1;36m" + " sksohel")
       slowprint ("\033[1;33m" + "         [+] Latest Update =>\033[1;36m" + " 17/3/2019")
       slowprint ("\033[1;33m" + "         [+] YouTube       =>\033[1;36m" + " sksohel")
       slowprint ("\033[1;33m" + "         [+] Github        =>\033[1;36m" + " sksohel")
       slowprint ("\033[1;91m -----------------------------------------------")
       slowprint ("\033[1;95m" + "          [+] sohelsk07.blogspot.com [+]          ")
       slowprint ("\033[1;91m -----------------------------------------------")
